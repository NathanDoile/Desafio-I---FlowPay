...
export function useObterDetalheEquipe() {

    const navigate = useNavigate();
    const location = useLocation();

    async function obterDetalheEquipe(categoriaEquipe) {
        try {
            const response = await obterDetalheEquipeApi(categoriaEquipe);
