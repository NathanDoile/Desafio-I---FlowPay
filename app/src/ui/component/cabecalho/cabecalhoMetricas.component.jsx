    ...
    <header className={`${BG_AZUL_ESCURO} text-white shadow-md`}>
      <div className="mx-auto flex max-w-[1400px] flex-col gap-4 px-4 py-6 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <button type="button" onClick={() => navigate("/")} className={`flex h-11 w-11 items-center justify-center rounded-xl ${BG_LARANJA} ${TEXTO_PRETO_BG_LARANJA} cursor-pointer transition-transform duration-200 hover:-translate-y-1 hover:shadow-md active:translate-y-0`}>
